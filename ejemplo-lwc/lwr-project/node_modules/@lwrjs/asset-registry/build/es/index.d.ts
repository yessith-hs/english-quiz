...
export declare class LwrAssetRegistry implements AssetRegistry {
    ...
    cacheDir: string;
    assetTranformers: AssetTransformPlugin[];
    ...
    getAsset<T extends AssetIdentifier, R extends RuntimeEnvironment>(assetId: T, runtimeEnvironment: R): Promise<AssetDefinition>;
