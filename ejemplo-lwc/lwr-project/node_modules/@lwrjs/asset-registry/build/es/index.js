...
function normalizeSpecifier(assetId, assetPathMap, resourcePaths, basePath) {
    ...
    //      - Individual files: the asset specifer is equal to a configured assets[i].urlPath
...
export class LwrAssetRegistry {
    ...
    runtimeEnvironment) {
        ...
        // INVARIANT: return must be a parseable mimetype compliant source
        // ex (SASS -> CSS, LESS -> CSS, PNG -> PNG optimized, ...)
        for (const transformPlugin of this.assetTranformers) {
            // eslint-disable-next-line no-await-in-loop
        ...
        // Here we do minimization, compression, offuscation, ...
        ...
        // STEP 5: Store the modified/tranformed version of the asset
