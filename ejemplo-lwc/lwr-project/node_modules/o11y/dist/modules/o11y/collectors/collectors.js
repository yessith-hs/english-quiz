...
class CoreCollector {
    ...
    async _uploadContents(contents, userInitiated) {
        const coreEnvelope = this._buildProtoEncodedCoreEnvelopeFrom(contents);
        let requestInit;
    ...
    get metricsCount() {
        ...
        if (this._metricsExtractors) {
            let metrics = this._metricsExtractors.getAllUpCounters();
    ...
    _buildProtoEncodedCoreEnvelopeFrom(contents) {
    ...
    _encodeCoreEnvelope(coreEnvelope) {
...
class HybridCollector {
    ...
    addRootActivityListeners(activityStarted, activityEnded) {
...
export { CoreCollector, HybridCollector };
