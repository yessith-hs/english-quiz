import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqMultiSiteGroupCardCartConfigurator extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfCpqMultiSiteGroupCardCartConfigurator';
              ...
              @track Label={MSGroupAndMember:"Group and Member"
      };
              pubsubEvent = [];
              customEvent = [];
