import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
 ...
 this.registerEvents();
        ...
        this.pubsubEvent[0] = {
          [interpolateWithRegex(`cpq_addtocart_response`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[0],0),
[interpolateWithRegex(`cpq_close_preview_cart`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[1],1),
[interpolateWithRegex(`cpq_preview_cart`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[2],2)
        };
        ...
        this.pubsubChannel1 = interpolateWithRegex(`cpq_cop_target_offer_radio`,this._allMergeFields,this._regexPattern,"noparse");
