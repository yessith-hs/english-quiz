...
import { OMNIDEF } from './cPQMultisiteConfiguratorMultiLanguage_def.js';
import tmpl from './cPQMultisiteConfiguratorMultiLanguage.html';
import tmpl_nds from './cPQMultisiteConfiguratorMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQMultisiteConfiguratorMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
