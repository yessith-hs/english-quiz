import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqMultiSiteCombobox extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfCpqMultiSiteCombobox';
              ...
              @track Label={MSAddToGroupLabel:"Add to Group"
      };
              pubsubEvent = [];
              customEvent = [];
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`groupListValues`,this._allMergeFields,this._regexPattern,"noparse");
