...
import { OMNIDEF } from './cPQCartConfiguratorMultiLanguage_def.js';
import tmpl from './cPQCartConfiguratorMultiLanguage.html';
import tmpl_nds from './cPQCartConfiguratorMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQCartConfiguratorMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
