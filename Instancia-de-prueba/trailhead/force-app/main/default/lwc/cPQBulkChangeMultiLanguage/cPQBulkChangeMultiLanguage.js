...
import { OMNIDEF } from './cPQBulkChangeMultiLanguage_def.js';
import tmpl from './cPQBulkChangeMultiLanguage.html';
import tmpl_nds from './cPQBulkChangeMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQBulkChangeMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
