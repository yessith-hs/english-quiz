...
import { OMNIDEF } from './cPQCreateOrderMultiLanguage_def.js';
import tmpl from './cPQCreateOrderMultiLanguage.html';
import tmpl_nds from './cPQCreateOrderMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQCreateOrderMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
