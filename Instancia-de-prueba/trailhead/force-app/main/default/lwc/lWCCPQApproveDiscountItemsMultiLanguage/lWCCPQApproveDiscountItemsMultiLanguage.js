...
import { OMNIDEF } from './lWCCPQApproveDiscountItemsMultiLanguage_def.js';
import tmpl from './lWCCPQApproveDiscountItemsMultiLanguage.html';
import tmpl_nds from './lWCCPQApproveDiscountItemsMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lWCCPQApproveDiscountItemsMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
