...
import { OMNIDEF } from './cPQSplitAndSubmitOrderEnglish_def.js';
import tmpl from './cPQSplitAndSubmitOrderEnglish.html';
import tmpl_nds from './cPQSplitAndSubmitOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQSplitAndSubmitOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
