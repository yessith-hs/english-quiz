import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqMultiSiteMembersTypeList extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfCpqMultiSiteMembersTypeList';
              ...
              @track Label={CPQSelectMultiSiteObject:"Select items to group."
      };
              pubsubEvent = [];
              customEvent = [];
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`multiSiteObjects`,this._allMergeFields,this._regexPattern,"noparse");
