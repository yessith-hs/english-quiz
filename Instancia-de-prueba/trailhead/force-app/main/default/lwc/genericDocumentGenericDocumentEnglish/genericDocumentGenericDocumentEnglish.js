...
import { OMNIDEF } from './genericDocumentGenericDocumentEnglish_def.js';
import tmpl from './genericDocumentGenericDocumentEnglish.html';
import tmpl_nds from './genericDocumentGenericDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class genericDocumentGenericDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
