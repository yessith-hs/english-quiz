...
import { OMNIDEF } from './cPQSingleMoveMultiLanguage_def.js';
import tmpl from './cPQSingleMoveMultiLanguage.html';
import tmpl_nds from './cPQSingleMoveMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQSingleMoveMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
