import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqMultiSiteApplyToGroup extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfCpqMultiSiteApplyToGroup';
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`applyToGroup`,this._allMergeFields,this._regexPattern,"noparse");
