import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqMultiSiteGroupsList extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={MSErrorsPartTwo:"errors on",
      MSWarningsPartTwo:"warnings on",
      MSWarningsErrorsPartOne:"There are",
      MSValidateAndPriceCompleted:"Validation and pricing was completed.",
