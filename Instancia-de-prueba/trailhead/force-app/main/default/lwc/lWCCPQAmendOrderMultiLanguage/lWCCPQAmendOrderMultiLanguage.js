...
import { OMNIDEF } from './lWCCPQAmendOrderMultiLanguage_def.js';
import tmpl from './lWCCPQAmendOrderMultiLanguage.html';
import tmpl_nds from './lWCCPQAmendOrderMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lWCCPQAmendOrderMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
