...
import { OMNIDEF } from './genericDocuSignSendEsignatureEnglish_def.js';
import tmpl from './genericDocuSignSendEsignatureEnglish.html';
import tmpl_nds from './genericDocuSignSendEsignatureEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class genericDocuSignSendEsignatureEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
