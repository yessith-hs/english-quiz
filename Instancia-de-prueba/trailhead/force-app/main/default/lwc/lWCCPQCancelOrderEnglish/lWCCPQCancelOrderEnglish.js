...
import { OMNIDEF } from './lWCCPQCancelOrderEnglish_def.js';
import tmpl from './lWCCPQCancelOrderEnglish.html';
import tmpl_nds from './lWCCPQCancelOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lWCCPQCancelOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
