...
import { OMNIDEF } from './cPQSubmitOrderMultiLanguage_def.js';
import tmpl from './cPQSubmitOrderMultiLanguage.html';
import tmpl_nds from './cPQSubmitOrderMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQSubmitOrderMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
