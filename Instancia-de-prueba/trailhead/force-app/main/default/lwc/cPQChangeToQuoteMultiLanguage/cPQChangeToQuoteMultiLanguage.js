...
import { OMNIDEF } from './cPQChangeToQuoteMultiLanguage_def.js';
import tmpl from './cPQChangeToQuoteMultiLanguage.html';
import tmpl_nds from './cPQChangeToQuoteMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQChangeToQuoteMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
