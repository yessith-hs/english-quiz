...
import { OMNIDEF } from './cPQCreateQuoteMultiLanguage_def.js';
import tmpl from './cPQCreateQuoteMultiLanguage.html';
import tmpl_nds from './cPQCreateQuoteMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQCreateQuoteMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
