...
import { OMNIDEF } from './cPQAssetViewerOrderFlowMultiLanguage_def.js';
import tmpl from './cPQAssetViewerOrderFlowMultiLanguage.html';
import tmpl_nds from './cPQAssetViewerOrderFlowMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQAssetViewerOrderFlowMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
