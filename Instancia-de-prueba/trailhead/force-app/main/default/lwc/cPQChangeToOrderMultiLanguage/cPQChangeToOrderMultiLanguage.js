...
import { OMNIDEF } from './cPQChangeToOrderMultiLanguage_def.js';
import tmpl from './cPQChangeToOrderMultiLanguage.html';
import tmpl_nds from './cPQChangeToOrderMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQChangeToOrderMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
