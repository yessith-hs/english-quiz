...
import { OMNIDEF } from './cPQBulkQuoteToOrderMultiLanguage_def.js';
import tmpl from './cPQBulkQuoteToOrderMultiLanguage.html';
import tmpl_nds from './cPQBulkQuoteToOrderMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQBulkQuoteToOrderMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
