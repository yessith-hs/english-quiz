import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqMultiSiteGroupsMember extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
              ...
              @track Label={CPQErrors:"Errors",
      CPQWarnings:"Warnings",
      CPQNotApplied:"Not Applied",
      CPQApplied:"Applied",
      CPQProcessing:"Processing"
      };
              pubsubEvent = [];
              customEvent = [];
