import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfCpqMultiSiteCreateGroup extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfCpqMultiSiteCreateGroup';
              ...
              @track Label={MSNewGroupLabel:"New Group",
      MSSaveLabel:"Save",
      MSCancelLabel:"Cancel",
      MSGroupDescLabel:"Group Description",
      MSGroupNameLabel:"Group Name",
      MSAddSelectedItemsToNewGroupInfoLabel:"selected items will be added to the new group",
      MSRenameGroupLabel:"Rename Group"
      };
              pubsubEvent = [];
              customEvent = [];
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`createGroupName`,this._allMergeFields,this._regexPattern,"noparse");
        pubsub.register(this.pubsubChannel0,this.pubsubEvent[0]);

        this.pubsubEvent[1] = {
          [interpolateWithRegex(`cpq_add_new_group_response`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[1],1),
[interpolateWithRegex(`modify_group`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[3],3),
[interpolateWithRegex(`cpq_updated_group`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[4],4)
        };
        this.pubsubChannel1 = interpolateWithRegex(`cpq_${this.recordId}_{Parent.channelType}`,this._allMergeFields,this._regexPattern,"noparse");
        ...
        this.pubsubChannel2 = interpolateWithRegex(`createGroupDescription`,this._allMergeFields,this._regexPattern,"noparse");
